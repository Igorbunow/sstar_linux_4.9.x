...
enum {
	...
	AHCI_CMD_TBL_SZ		= AHCI_CMD_TBL_HDR_SZ + (AHCI_MAX_SG * 16),
	AHCI_CMD_TBL_AR_SZ	= AHCI_CMD_TBL_SZ * AHCI_MAX_CMDS,
	AHCI_PORT_PRIV_DMA_SZ	= AHCI_CMD_SLOT_SZ/*1024*/ + AHCI_CMD_TBL_AR_SZ/*2816*/ +
				  AHCI_RX_FIS_SZ/*256*/,
	AHCI_PORT_PRIV_FBS_DMA_SZ	= AHCI_CMD_SLOT_SZ +
					  AHCI_CMD_TBL_AR_SZ +
					  (AHCI_RX_FIS_SZ * 16),
	...
	HOST_EM_LOC		= (0x1c << 1), /* Enclosure Management location */
	HOST_EM_CTL		= (0x20 << 1), /* Enclosure Management Control */
	...
	/* registers for each SATA port */
	PORT_LST_ADDR		= (0x00 << 1), /* command list DMA addr */
	...
	PORT_FBS		= (0x40 <<1), /* FIS-based Switching */
	PORT_DEVSLP		= (0x44 <<1), /* device sleep */
